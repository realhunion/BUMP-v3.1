...
class MyUserProfileFetcher {
    ...
    func monitorMyProfile() {
        ...
        let uProfile = UserProfile(userID: "myUID", email: "email", name: "Hunain Ali", description: "🌱", imageURL: "fixhttps://firebasestorage.googleapis.com/v0/b/pluto-grinnell.appspot.com/o/User-Profile-Images%2FryefXA95twU6lFE94wdaTR8PhSt1.jpg?alt=media&token=aad80fc5-6d34-4f2b-b65a-4711088bcb03", interests: [], dateJoined: Timestamp(date: Date()), classYear: 2)
